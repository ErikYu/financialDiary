...
<template>
  <div class="cov-vue-date">
    <div class="datepickbox" style="height: 100%;">
      <input style="line-height: 50px;" type="text" class="cov-datepicker" readonly
      ...
      <div class="cov-date-body" :style="{'background-color':colors&&colors.header}">
        ...
        <div class="cov-date-box" v-if="layer==='day'">
          <div class="cov-picker-box">
            ...
            <div class="day" v-for="day in dayList" @click="checkDay(day)"
                 :class="{'checked':day.checked,'unavailable':day.unavailable,'passive-day': !(day.inMonth)}"
                 :style="day.checked?{background:colors&&colors.checkedDate}:{}">{{day.value}}
            </div>
          </div>
        </div>
